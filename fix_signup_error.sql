-- FIX SIGNUP ERROR
-- This fixes the database error when saving new users
...
-- 12. Check and fix any constraint issues
-- First, let's see what constraints exist on the profiles table
-- This will help us understand if there are any issues with the table structure 